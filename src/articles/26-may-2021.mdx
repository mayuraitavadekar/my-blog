...
We needed a language which:
  ...
  3. <b>is statically typed (easy to debug errors):<b/>
...
Go seems very much underrated to me. It was perfect for us. It is language which was designed by keeping serverside in mind, We rewrote all of our services in Go. We moved our database from MongoDB to MySQL. We use
