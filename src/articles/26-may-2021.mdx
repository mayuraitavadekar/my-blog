...
We needed a language which:
  ...
  4. <b>has great standard library:</b>
      ...
      In JavaScript world, everything is OSS. Though node.js standard library has few good functions, it does not cover everything a programmer needs on server         side. You have to reply on third party applications. It is difficult when you are running your software on production level where few hundread/thousand           people using it. As soon as anything in that third party library changes, you have to update it in your software and it might break your functionality.     
