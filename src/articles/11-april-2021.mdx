...
in my personal projects as well as my in my job. So there are some experiences - good and bad. I'm writting them here.
...
That's why people who maintains frameworks which are built on top of JS, they roll out updates constantly. Also, Due to very large community of JS, everyday we hear name of a new framework which creates <b>JavaScript fatigue</b> among the new programmers. In JS world, last week code is legacy code. So people who are building things and deploying them to production,
...
I personally wrote few thousands lines of server-side JS. I know the consequences. As your req/sec grows exponentially. You really need to consider lot of things.  That's why these days, I do not write backends in JS. I either use Go (most of the time) or Java.
