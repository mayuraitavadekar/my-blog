...
Node.js is great for IO operations. It's single threadedm non-blocking mechanism works great if your application is heavily data dependent and you are not
